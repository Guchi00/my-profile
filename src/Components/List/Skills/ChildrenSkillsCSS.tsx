...
export const data = [
  ...
  {
    imageUrl: "https://andrewborstein.com/assets/img/bootstrap.png",
    subtitle: "Bootsrap",
  },
];

export const ChildrenSkillsCSS = (props: SkillsProps) => {
  return (
    <>
